  ...
  return (
    <div className="homeContainer">
      ...
      <section className="section3">
        ...
        <h1>BECOME OUR CUSTOMER & GET SPECIAL OFFER EVERYDAY</h1>
        <p>Join our exclusive community today and unlock incredible daily deals on the freshest, premium-quality seafood delivered directly to your doorstep with care and precision. Experience the difference of authentic ocean-to-table freshness.</p>
